...
var Footer = function () {
    ...
    var pathsToMinimize = ['/verify-email', '/sign-up', '/sign-in'];
        ...
        <div className="relative border-t border-gray-200 py-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <Link href="https://x.com/FellowTravell20" className="inline-flex items-center space-x-2 text-muted-foreground hover:text-gray-900 transition-colors duration-200" target="_blank" rel="noopener noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            ...
            <div className="text-center md:text-right md:mr-4">
              ...
              <Link href="/sign-up" className="inline-block bg-gray-800 text-white text-sm px-6 py-2 rounded hover:bg-gray-700 transition-colors duration-300">
                Get Started
              </Link>
            </div>
          </div>
          ...
          <div className="mt-6 pt-4 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              {['Terms', 'Privacy Policy', 'Cookie Policy'].map(function (item) { return (<Link key={item} href="#" className="text-xs text-gray-500 hover:text-gray-700 transition-colors duration-300">
                  {item}
                </Link>); })}
            </div>
          </div>
