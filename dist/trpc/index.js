...
export var appRouter = router({
    ...
    getInfiniteProducts: publicProcedure
        ...
        var query, cursor, sort, _c, limit, excludeId, queryOpts, payload, parsedQueryOpts, page, sortOption, _d, items, hasNextPage, nextPage, selectedItems, shuffledItems;
        var input = _b.input;
            ...
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, payload.find({
                            collection: 'products',
                            where: __assign(__assign({ approvedForSale: {
                                    equals: 'approved',
                                } }, parsedQueryOpts), (excludeId
                                ? {
                                    id: {
                ...
                case 2:
                    ...
                    if (excludeId) {
                        shuffledItems = items.sort(function () { return 0.5 - Math.random(); });
